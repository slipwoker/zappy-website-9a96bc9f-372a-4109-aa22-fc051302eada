    ...
    function getFieldError(field) {
      ...
      if (value.trim() !== '') {
        if (type === 'email' && !validators.email(value)) {
          return field.getAttribute('data-error-email') || 'Please enter a valid email address.';
        }

        if (type === 'tel' && !validators.phone(value)) {
          return field.getAttribute('data-error-phone') || 'Please enter a valid phone number.';
        }

        if (minLength && !validators.minLength(value, minLength)) {
          return field.getAttribute('data-error-minlength') || 'Input is too short.';
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            contactForm.reset();
            contactForm.querySelectorAll('.field-success').forEach(function (f) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "יוגב בריאות טבעית משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9a96bc9f-372a-4109-aa22-fc051302eada',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9a96bc9f-372a-4109-aa22-fc051302eada';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9a96bc9f-372a-4109-aa22-fc051302eada';
